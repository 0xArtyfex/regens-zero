    ...
    ITraitCollection
{
    ...
    constructor() ERC721("rzPrueba2", "RZ2") {}
    ...
    function mint(uint256 amount, uint256 layer) public payable nonReentrant {
        uint256 i;
        for (i = 0; i < amount; i++) {
        ...
        returns (string memory)
    {
        ...
        return
            bytes(imageUri).length > 0
                ? string(abi.encodePacked(imageUri, tokenId.toString()))
                : "";
    }
